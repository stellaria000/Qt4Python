'''
    BASIC LAYOUTS SHOWS HOW TO USE THE STANDARD LAYOUT MANAGERS THAT ARE AVAILABLE IN QT WIDGETS.
...
class Dialog(QDialog):
    ...
    def __init__(self):
        ...
        big_editor.setPlainText("THIS WIDGET TAKES UP ALL THE REMAINING SPACE IN THE TOP LEVEL LAYOUT.")
    ...
    def create_grid_group_box(self):
        ...
        self._small_editor.setPlainText("THIS WIDGET TAKES UP TWO THIRDS OF THE GRID LAYOUT.")
    ...
    def create_form_group_box(self):
        ...
        layout.addRow(QLabel("Line 2: "), QComboBox())
