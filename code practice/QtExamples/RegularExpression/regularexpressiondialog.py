...
class DisplayLineEdit(QLineEdit): 
    def __init__(self, parent: QWidget= None):
        ...
        self.disablePalette.setBrush(QPalette.base, self.disablePalette.brush(QPalette.Disabled, QPalette.base, ))
        ...
        self.copyAction.triggered.connect(lambda: QGuiApplication.clipboard().setText(self.text()))
...
class RegularExpressionDialog(QDialog):
    def __init__(self, parent: QWidget= None)-> None:
        ...
        self.doMatchesEverythingOptionCheckBox.toggled.connect(self.refresh)
        ...
        self.subjectTextEdit.setPlainText("My office number is 000-000-0--000, my mobile is 000-0000--00000" " instead.")

        self.refresh()
    
    def setResultUiEnabled(self, enabled: bool):
        self.matchDetailsTreeWidget.setEndabled(enabled)
    ...
    def refresh(self):
        ...
        self.setTextColor(self.patternLineEdit, self.subjectTextEdit.palette().color(QPalette.Text), )

        self.matchDetailsTreeWidget.clear()
        self.namedGroupsTreeWidget.clear()
        self.regexStatusLabel.setText("")
        ...
        if not self.regularExpression.isValid():
            self.setTextColor(self.patternLinEdit, Qt.red)
